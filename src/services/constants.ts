...
export const WS_ENDPOINT_ORDERS = "wss://norma.nomoreparties.space/orders"
export const WS_ENDPOINT_ORDERS_ALL = "wss://norma.nomoreparties.space/orders/all"


export const COOKIE_NAME_ACCESS_TOKEN = 'accessToken'
